...
// export const UpdateUser = async (req,res)=>{
//     try {
//         const UpdateUser = await Users.update({id: req.params.userId}, {$set: req.body});
...
export const Login = async (req, res) => {
    try {
        ...
        const accessToken = jwt.sign({userId, name, email}, process.env.ACCESS_TOKEN_SECRET,{expiresIn:'120s'});
